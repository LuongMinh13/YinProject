...
function Test2() {
    ...
    useEffect(() => {
        ...
        getImageDimensions(ImageSlider[0].mainimage);
    }, [ImageSlider]);
            ...
            <div className="home-view" style={{ width: sliderDimensions.width, height: sliderDimensions.height }}>
                <div className='main-bg'>
                    {ImageSlider.map((url, index) => (
                        <div
                            key={index}
                            className={index === currentIndex ? 'main-photo _active' : 'main-photo'}
                            style={{
                                clipPath: currentIndex === index ? 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' : 'polygon(50% 0%, 40% 50%, 50% 100%, 60% 50%)',
